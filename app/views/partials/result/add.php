    <template id="resultAdd">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Add New Result</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="result/add" method="post">
    ...
    <script>
	var ResultAddComponent = Vue.component('resultAdd', {
		template : '#resultAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
		...
		data : function() {
			return {
				...
				data : {
					exam_name: '',exam_date: '',result_pub_date: '',student_name: '',student_class: '',Student_roll: '',bangla: '',english: '',mathametics: '',social_science: '',general_science: '',physics: '',camistry: '',boilogy: '',ict: '',agricultur: '',economics: '',geography: '',history: '',riligion: '',gpa: '',gread: '',status: '',
				},
			}
		},
		computed: {
		...
		methods: {
			...
			resetForm : function(){
				this.data = {exam_name: '',exam_date: '',result_pub_date: '',student_name: '',student_class: '',Student_roll: '',bangla: '',english: '',mathametics: '',social_science: '',general_science: '',physics: '',camistry: '',boilogy: '',ict: '',agricultur: '',economics: '',geography: '',history: '',riligion: '',gpa: '',gread: '',status: '',};
