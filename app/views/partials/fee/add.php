                ...
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Add New Fee</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="fee/add" method="post">
    ...
    <script>
	var FeeAddComponent = Vue.component('feeAdd', {
		template : '#feeAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
