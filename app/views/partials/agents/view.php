    <template id="agentsView">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">View  Agents</h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div  class=" animated fadeIn">
                                <div v-show="!loading">
                                    ...
                                    <div v-if="editbutton || deletebutton || exportbutton" class="py-3">
                                        <span >
                                            <router-link class="btn btn-sm btn-info has-tooltip" v-if="editbutton"  :to="'/agents/edit/'  + data.AGENT_CODE">
                                            <i class="fa fa-edit"></i> 
                                            </router-link>
                                            <button @click="deleteRecord" class="btn btn-sm btn-danger" v-if="deletebutton" :to="'/agents/delete/' + data.AGENT_CODE">
    ...
    <script>
	var AgentsViewComponent = Vue.component('agentsView', {
		template : '#agentsView',
