    <template id="fees_collectionEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  Fees Collection</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'fees_collection/edit/' + data.id" method="post">
    ...
    <script>
	var Fees_CollectionEditComponent = Vue.component('fees_collectionEdit', {
		template : '#fees_collectionEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 'fees_collectionedit',
			},
			apipath : {
				type : String,
				default : 'fees_collection/edit',
			},
		},
		data: function() {
			return {
