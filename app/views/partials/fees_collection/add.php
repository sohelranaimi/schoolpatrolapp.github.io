    <template id="fees_collectionAdd">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Add New Fees Collection</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="fees_collection/add" method="post">
    ...
    <script>
	var Fees_CollectionAddComponent = Vue.component('fees_collectionAdd', {
		template : '#fees_collectionAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
				type : String,
			...
			routename : {
				type : String,
				default : 'fees_collectionadd',
			},
			apipath : {
				type : String,
				default : 'fees_collection/add',
			},
		},
		data : function() {
			return {
		...
		computed: {
			pageTitle: function(){
				return 'Add New Fees Collection';
			},
		},
		methods: {
			actionAfterSave : function(response){
				this.$root.$emit('requestCompleted' , this.msgaftersave);
				this.$router.push('/fees_collection');
			},
			resetForm : function(){
